...
initial_message = "We need to analyze the quarterly sales data and prepare a summary report. Please coordinate the team to complete this task. Check with all workers without asking me any follow up questions."
